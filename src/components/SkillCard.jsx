...
const SkillCard = ({ imgSrc, label, desc, classes }) => {
  return (
    <div className={`flex items-center gap-4 ring-2 ring-inset ring-[#273c75]/10 bg-white rounded-2xl p-4 hover:bg-[#7f8fa6]/10 transition-all group animate-gentle-float ${classes}`}>
